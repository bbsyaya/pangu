...
public class RandomUtils {
	...
	public static int getRandomSpan(int min, int max) {
	...
	public static String getRandomNumbersAndCapitalLetters(int length) {
		return getRandom(NUMBERS_CAPITAL_LETTERS, length);
	}

	public static String getRandomNumbersAndLowerCaseLetters(int length) {
		return getRandom(NUMBERS_LOWER_CASE_LETTERS, length);
	}
	...
	public static String getRandom(String source, int length) {
		return StringUtil.isBlank(source) ? null : getRandom(
